        ...
        <div className="container mx-auto min-h-screen flex items-center justify-center flex-col px-4">
          ...
          <div className="flex flex-wrap items-center justify-center my-16">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-teal-400 hover:bg-teal-700 transition-colors duration-300 rounded-lg h-12 inline-flex items-center justify-center px-3 my-2"
            >
              <FontAwesomeIcon color="#1a202c" size="lg" icon={faComments} />
              <span className="ml-3 text-gray-900">Contact Me</span>
            </a>
          </div>
        </div>
      </div>
